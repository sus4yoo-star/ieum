...
function fbCopy(lang: string, kind: FeedbackKind): FbCopy {
  const feedbackMap: Record<string, FbCopy> = {
    ko: {
      ...
      send: "보내기",
      sending: "보내는 중…",
      thanks: "소중한 마음 고맙습니다 🌿 더 따뜻한 셀라이 되겠습니다.",
      error: "잠시 후 다시 시도해 주세요.",
    },
    en: {
      menu: "Feedback",
      title: "How was 셀라 for you?",
    ...
    fr: {
      menu: "Avis",
      title: "Comment était 셀라 pour vous ?",
    ...
    ro: {
      menu: "Feedback",
      title: "Cum a fost 셀라 pentru tine?",
    ...
    ta: {
      menu: "கருத்து",
      title: "셀라 உங்களுக்கு எப்படி இருந்தது?",
  ...
  const inquiryMap: Record<string, FbCopy> = {
    ko: {
      menu: "문의하기",
      title: "무엇이든 물어보세요",
      sub: "셀라을 사용하시면서 궁금하거나 불편한 점이 있으신가요? 알려주시면 빠르게 답변드리겠습니다.",
