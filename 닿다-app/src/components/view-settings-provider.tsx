 ...
 * 셀라 and SELAH don't share state when both are installed on the
 * same device.
 *
...
const FONT_KEY = "manna_font_size";
const CONTRAST_KEY = "manna_contrast";
const TTS_KEY = "manna_tts_auto";
