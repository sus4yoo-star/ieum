...
const ko: FeatureStrings = {
  ...
  unfavorite: "즐겨찾기 해제",
  favoritesTitle: "즐겨찾기",
  favoritesEmpty: "아직 즐겨찾기한 글이 없어요.",
  showAllChats: "전체 대화",
  showFavorites: "즐겨찾기만",
...
const en: FeatureStrings = {
  ...
  guideStep3Body:
    "Save the words you receive, or share them with family on KakaoTalk.",
  guideNext: "Next",
  guideDone: "Begin",
  guideSkip: "Skip",
  ...
  journalExport: "Heart Journal PDF",
