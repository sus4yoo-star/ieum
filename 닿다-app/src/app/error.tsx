...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    console.error("[셀라] unhandled error:", error);
  }, [error]);

  return (
    <main className="flex min-h-dvh flex-col items-center justify-center bg-[#14162b] px-6 text-center text-[#f3efe6]">
      <div className="max-w-sm">
        ...
        <div className="flex flex-col gap-2.5">
          <button
            type="button"
            onClick={reset}
            className="rounded-2xl bg-[#e3b975] px-5 py-3 text-[14px] font-semibold text-[#14162b] transition hover:brightness-110 active:scale-[0.98]"
          >
            다시 시도
          </button>
