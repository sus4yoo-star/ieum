        ...
        <div className="prose prose-neutral max-w-none text-[15px] leading-relaxed space-y-8">
          <section>
            <p className="text-neutral-700">
              ...
              등에 관한 법률, 개인정보 보호법 등 관련 법령을 준수하며, 셀라(
              이하 &quot;서비스&quot;) 이용자의 개인정보를 소중히 보호하기 위해
              다음과 같은 처리방침을 두고 있습니다. 셀라은 이용자가 마음을
          ...
          <section>
            ...
            <p className="mt-3 text-sm text-neutral-600">
              회사는 대화 내용에서 민감정보(건강, 사상 등)가 자연스럽게 언급될
              수 있음을 인지하며, 이를 별도의 마케팅·프로파일링 목적으로
              가공·활용하지 않습니다.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-1">
              ...
              <li>
                ...
                이용자는 서비스 내에서 개별 대화를 직접 삭제할 수 있습니다.
              </li>
              <li>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 mt-2 space-y-1">
              ...
              <li>
                이용자 본인 또는 타인의 생명·신체에 급박한 위험이 있어 긴급히
                필요한 경우 (예: 자살 위험이 명백한 상황에서 응급기관에 협조)
              </li>
            </ol>
          </section>
